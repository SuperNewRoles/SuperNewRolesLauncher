...
#[tauri::command]
pub fn get_launcher_settings<R: Runtime>(app: AppHandle<R>) -> Result<LauncherSettings, String> {
    settings::load_or_init_settings(&app)
}

#[tauri::command]
pub fn save_launcher_settings<R: Runtime>(
    app: AppHandle<R>,
...
#[tauri::command]
pub fn check_profile_ready<R: Runtime>(
    app: AppHandle<R>,
