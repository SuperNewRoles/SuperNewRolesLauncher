...
const ja = {
  ...
  "credit.title": "クレジット",
  "credit.summary": "{launcherName} の開発・利用に関わるクレジットです。",
  "credit.group.project": "プロジェクト",
  "credit.group.technology": "技術 / 参考",
  "credit.group.links": "公式リンク",
  "credit.supernewrolesLine": "{modName}: {modName} Team / Contributors",
  ...
  "launcher.title": "ランチャー設定 / {modShort}インストール",
  ...
  "launcher.releaseTagLabel": "{modShort}タグ",
  ...
  "settings.tab": "設定",
  "preset.tab": "プリセット",
  "gameServers.tab": "マッチメイキング",
  "gameServers.subtitle": "公開ルームを検索・参加できます",
  "gameServers.filtersLabel": "ルーム絞り込み",
  "gameServers.serverLabel": "サーバー",
  "gameServers.statusLabel": "状態",
  "gameServers.mapLabel": "マップ",
  "gameServers.filterAll": "すべて",
  "gameServers.searchPlaceholder": "ルーム名・ホスト名で検索",
  "gameServers.joinableOnly": "参加可能のみ",
  "gameServers.autoRefresh": "5秒ごとに自動更新",
  "gameServers.refresh": "更新",
  "gameServers.refreshing": "更新中...",
  "gameServers.stats.total": "総ルーム数",
  "gameServers.stats.public": "公開ルーム数",
  "gameServers.stats.joinable": "参加可能",
  "gameServers.stats.full": "満員",
  "gameServers.stats.ingame": "ゲーム中",
  "gameServers.lastUpdated": "最終更新: {time}",
  "gameServers.statusIdle": "ルーム一覧を表示しています。",
  "gameServers.statusLoading": "ルーム一覧を取得中...",
  "gameServers.statusRefreshing": "ルーム一覧を更新中...",
  "gameServers.statusUpdated": "ルーム一覧を更新しました。",
  "gameServers.statusLoadFailed": "ルーム一覧の取得に失敗しました: {error}",
  "gameServers.empty": "表示できるルームがありません。",
  "gameServers.table.room": "ルーム名",
  "gameServers.table.status": "状態",
  "gameServers.table.players": "プレイヤー数",
  "gameServers.table.impostors": "インポスター",
  "gameServers.table.map": "マップ",
  "gameServers.table.action": "操作",
  "gameServers.hostName": "ホスト: {host}",
  "gameServers.players": "{current}/{max} 人",
  "gameServers.playersLabel": "人数",
  "gameServers.ipPort": "IP / Port: {ip}:{port}",
  "gameServers.mapId": "マップ: {map}",
  "gameServers.impostors": "インポスター数: {count}",
  "gameServers.mapShort": "マップ",
  "gameServers.impostorsShort": "インポスター",
  "gameServers.roomCodeLabel": "コード",
  "gameServers.languageLabel": "言語",
  "gameServers.language": "言語: {language}",
  "gameServers.details": "詳細",
  "gameServers.detail.ipPort": "IP / Port",
  "gameServers.detail.platform": "Platform",
  "gameServers.detail.gameState": "GameState",
  "gameServers.detail.quickChat": "QuickChat",
  "gameServers.quickChat.free": "フリーチャット",
  "gameServers.quickChat.quick": "クイックチャット",
  "gameServers.quickChat.unknown": "不明 ({value})",
  "gameServers.gameState.recruiting": "募集中",
  "gameServers.gameState.starting": "開始中",
  "gameServers.gameState.started": "開始済み",
  "gameServers.gameState.ended": "終了",
  "gameServers.gameState.destroyed": "破棄",
  "gameServers.gameState.unknown": "不明 ({value})",
  "gameServers.join": "参加",
  "gameServers.joinUnavailable": "参加不可",
  "gameServers.joinJoining": "参加中...",
  "gameServers.copyCode": "コードコピー",
  "gameServers.copyCodeCopied": "コピー済み",
  "gameServers.copyCodeSuccess": "コードをコピーしました。",
  "gameServers.copyCodeFailed": "コードのコピーに失敗しました。",
  "gameServers.joinSuccess": "接続しました。",
  "gameServers.joinFailed": "参加失敗: {message}",
  "gameServers.joinTransportUnreachable":
    "Among Usが起動していない可能性があります。起動後にもう一度参加してください。",
  "gameServers.joinTransportError": "参加通信に失敗しました。もう一度お試しください。",
  "gameServers.serverSaveFailed": "サーバー選択の保存に失敗しました: {error}",
  ...
  "settings.customDll.title": "カスタムDLL",
  "settings.customDll.description": "任意のSuperNewRoles.dllを現在のプロファイルへ読み込みます。",
  "settings.customDll.open": "DLLを読み込む",
  "settings.customDll.warningTitle": "カスタムDLLの読み込みに関する警告",
  "settings.customDll.warningSecurity":
    "信頼できるDLLだけを選択してください。DLLは任意のコードを実行でき、PCやデータに影響を与える可能性があります。",
  "settings.customDll.warningGameClosed": "置き換える前にAmong Usを完全に終了してください。",
  "settings.customDll.warningUpdate":
    "「自動アップデートを無効化する」を選ばない場合、次回の自動更新でカスタムDLLが上書きされる可能性があります。",
  "settings.customDll.warningReinstall":
    "公式プロファイルを再インストールすると、カスタムDLLと自動アップデート無効設定の両方がリセットされます。",
  "settings.customDll.warningSingleFile":
    "コピーされるのは選択したDLLだけです。依存DLLやその他のファイルはコピーされません。",
  "settings.customDll.selectedPath": "選択したDLL",
  "settings.customDll.reselect": "選び直す",
  "settings.customDll.disableAutoUpdate": "自動アップデートを無効化する",
  "settings.customDll.cancel": "キャンセル",
  "settings.customDll.next": "次へ",
  "settings.customDll.dialogTitle": "SuperNewRoles.dllを選択",
  "settings.customDll.processing": "カスタムDLLを適用しています...",
  "settings.customDll.successTitle": "カスタムDLLを適用しました",
  "settings.customDll.successMessage": "リリースタグ: {tag}\n適用先: {path}",
  "settings.customDll.failedWithError": "カスタムDLLの適用に失敗しました: {error}",
  "settings.customDll.invalidFileName": "SuperNewRoles.dllという名前のDLLを選択してください。",
  "settings.customDll.close": "閉じる",
  ...
  "settings.general.uninstallConfirmMessage":
    "{modName}の展開済みファイルを削除します。続行しますか？",
  ...
  "releases.loading": "{modShort}タグを取得中...",
  "releases.done": "{modShort}タグ取得完了",
  "releases.none": "利用可能なタグがありません",
  "releases.failed": "{modShort}タグ取得失敗: {error}",
  ...
  "migration.importPathRequired": ".{migrationExt} のパスを入力してください。",
  ...
  "preset.title": "プリセット共有 (.{presetExt})",
  ...
  "preset.exportPathPlaceholder": "C:\\path\\to\\presets.{presetExt} (空で自動)",
  "preset.exportDialogTitle": "書き出し先を選択",
  "preset.exportSelected": "選択をエクスポート",
  "preset.importPathPlaceholder": "C:\\path\\to\\presets.{presetExt}",
  ...
  "preset.inspectPathRequired": "読み込む .{presetExt} のパスを入力してください。",
  ...
  "preset.importPathRequired": "インポート元の .{presetExt} パスを入力してください。",
  ...
  "install.tagRequired": "先に{modShort}タグを選択してください。",
  ...
  "launch.steamNotRunningTitle": "Steamが起動していません",
  "launch.steamNotRunningMessage":
    "Steamが起動していないと、Among Us内でログインされない場合があります。先にSteamを起動してください。",
  "launch.steamNotRunningContinue": "それでも起動する",
  ...
  "installFlow.welcome": "{launcherName}へようこそ!",
  "installFlow.welcomeHint": "まずは「はじめる」を押して{modName}をインストールしよう!",
  ...
  "installFlow.versionLabelSNR": "{modName} バージョン",
  ...
  "installFlow.importDescription":
    "必要な場合は、既存{modShort}フォルダまたはお引越しアーカイブからデータを取り込みできます。\n初めてプレイする場合はそのまま「次へ」を押してください。",
  "installFlow.importEnable": "インストール済みの{modName}からデータを取り込む",
  ...
  "onboarding.welcome.title": "{launcherName}へようこそ！",
  "onboarding.welcome.body": "{launcherName}の機能を簡単にご紹介します。",
  "onboarding.launch.title": "起動",
  "onboarding.launch.body": "「起動」ボタンを押して{modName}を起動できます！",
