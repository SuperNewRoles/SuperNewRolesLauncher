...
const ja = {
  ...
  "settings.customDll.description": "任意の{dllName}を現在のプロファイルへ読み込みます。",
  ...
  "settings.customDll.dialogTitle": "{dllName}を選択",
  ...
  "settings.customDll.invalidFileName": "{dllName}という名前のDLLを選択してください。",
