...
const ja = {
  ...
  "gameServers.joinJoining": "Join中...",
  "gameServers.joinSuccess": "接続しました。",
  "gameServers.joinFailed": "Join失敗: {message}",
  "gameServers.joinTransportUnreachable":
    "Among Usが起動していない可能性があります。起動後にもう一度Joinしてください。",
  "gameServers.joinTransportError": "Join通信に失敗しました。もう一度お試しください。",
