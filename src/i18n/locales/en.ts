...
const en: Record<keyof typeof ja, string> = {
  ...
  "credit.summary": "Credits for the development and resources behind {launcherName}.",
  ...
  "launcher.title": "Launcher Settings / {modShort} Install",
  ...
  "launcher.releaseTagLabel": "{modShort} tag",
  ...
  "preset.tab": "Presets",
  "gameServers.tab": "Matchmaking",
  "gameServers.subtitle": "Search and join public rooms.",
  "gameServers.filtersLabel": "Room filters",
  "gameServers.serverLabel": "Server",
  "gameServers.statusLabel": "Status",
  "gameServers.mapLabel": "Map",
  "gameServers.filterAll": "All",
  "gameServers.searchPlaceholder": "Search by room or host",
  "gameServers.joinableOnly": "Joinable only",
  "gameServers.autoRefresh": "Auto refresh every 5s",
  "gameServers.refresh": "Refresh",
  "gameServers.refreshing": "Refreshing...",
  "gameServers.stats.total": "Total Rooms",
  "gameServers.stats.public": "Public Rooms",
  "gameServers.stats.joinable": "Joinable",
  "gameServers.stats.full": "Full",
  "gameServers.stats.ingame": "In Game",
  "gameServers.lastUpdated": "Last updated: {time}",
  "gameServers.statusIdle": "Showing room list.",
  "gameServers.statusLoading": "Loading room list...",
  "gameServers.statusRefreshing": "Refreshing room list...",
  "gameServers.statusUpdated": "Room list updated.",
  "gameServers.statusLoadFailed": "Failed to load room list: {error}",
  "gameServers.empty": "No matching rooms found.",
  "gameServers.table.room": "Room",
  "gameServers.table.status": "Status",
  "gameServers.table.players": "Players",
  "gameServers.table.impostors": "Impostors",
  "gameServers.table.map": "Map",
  "gameServers.table.action": "Action",
  "gameServers.hostName": "Host: {host}",
  "gameServers.players": "{current}/{max} players",
  "gameServers.playersLabel": "Players",
  "gameServers.ipPort": "IP / Port: {ip}:{port}",
  "gameServers.mapId": "Map: {map}",
  "gameServers.impostors": "Impostors: {count}",
  "gameServers.mapShort": "Map",
  "gameServers.impostorsShort": "Impostors",
  "gameServers.roomCodeLabel": "Code",
  "gameServers.languageLabel": "Language",
  "gameServers.language": "Language: {language}",
  "gameServers.details": "Details",
  ...
  "gameServers.quickChat.free": "Free Chat",
  "gameServers.quickChat.quick": "Quick Chat",
  "gameServers.quickChat.unknown": "Unknown ({value})",
  "gameServers.gameState.recruiting": "Recruiting",
  "gameServers.gameState.starting": "Starting",
  "gameServers.gameState.started": "Started",
  "gameServers.gameState.ended": "Ended",
  "gameServers.gameState.destroyed": "Destroyed",
  "gameServers.gameState.unknown": "Unknown ({value})",
  "gameServers.join": "Join",
  "gameServers.joinUnavailable": "Unavailable",
  "gameServers.joinJoining": "Joining...",
  "gameServers.copyCode": "Copy Code",
  "gameServers.copyCodeCopied": "Copied",
  "gameServers.copyCodeSuccess": "Room code copied.",
  "gameServers.copyCodeFailed": "Failed to copy room code.",
  "gameServers.joinSuccess": "Connected.",
  "gameServers.joinFailed": "Join failed: {message}",
  "gameServers.joinTransportUnreachable":
    "Among Us may not be running. Start Among Us and try Join again.",
  "gameServers.joinTransportError": "Join request failed. Please try again.",
  "gameServers.serverSaveFailed": "Failed to save selected server: {error}",
  ...
  "migration.overlay.importDescription": "Select a .snrdata archive to import.",
  ...
  "releases.loading": "Fetching {modShort} tags...",
  "releases.done": "{modShort} tags loaded",
  "releases.none": "No available tags",
  "releases.failed": "Failed to fetch {modShort} tags: {error}",
  ...
  "migration.importPathRequired": "Enter the path to a .{migrationExt} file.",
  ...
  "preset.title": "Preset Sharing (.{presetExt})",
  ...
  "preset.exportPathPlaceholder": "C:\\path\\to\\presets.{presetExt} (auto when empty)",
  ...
  "preset.inspectPathRequired": "Enter the .{presetExt} path to inspect.",
  ...
  "preset.importPathRequired": "Enter the source .{presetExt} path.",
  ...
  "install.tagRequired": "Select a {modShort} tag first.",
  ...
  "installFlow.welcome": "Welcome to {launcherName}!",
  "installFlow.welcomeHint": 'Press "Start" to install {modName} first!',
  ...
  "installFlow.versionLoading": "Fetching version information...",
  "installFlow.versionLabelSNR": "{modName} version",
  ...
  "installFlow.importDescription":
    'If needed, import data from an existing {modShort} folder or a migration archive before finishing installation.\nIf this is your first time playing, press "Next" to continue.',
  "installFlow.importEnable": "Import SaveData from existing {modName}",
  ...
  "installFlow.importArchiveSelect": "Select archive",
  "installFlow.importArchivePath": "Archive path",
  "installFlow.importArchiveNotConfigured": "Select a migration archive before continuing.",
  "installFlow.importArchivePassword": "Archive password",
  "installFlow.importArchivePasswordRequired": "Enter the archive password before continuing.",
  "installFlow.importArchivePasswordChecking": "Validating archive password...",
  "installFlow.importArchivePasswordValid": "Archive password is valid.",
  "installFlow.importArchivePasswordInvalid": "Archive password is incorrect.",
  "installFlow.importArchivePasswordCheckFailed": "Failed to validate archive password: {error}",
  ...
  "installFlow.importPreviewListTitle": "The following settings will be imported.",
  ...
  "installFlow.importSummaryEnabledMigration": "Enabled (migration archive)",
