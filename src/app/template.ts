          ...
          <div class="settings-layout">
            ...
            <div class="settings-content">
              ...
              <section id="settings-panel-epic" class="settings-category-panel" data-settings-panel="epic" role="tabpanel" aria-labelledby="settings-category-epic" hidden>
                <section class="card settings-epic-card-shell">
                  <div class="epic-login-header settings-epic-header">
                    <div class="epic-icon">
                    ...
                    <h2 class="step-title">${t("epic.title")}</h2>
                  </div>
                  <p class="epic-hint settings-epic-hint">${t("epic.loginDescription")}</p>

                  <div class="epic-login-card settings-epic-card">
                    ...
                    <div class="settings-epic-actions">
                    ...
                    <div class="row settings-epic-code-row">
                      <input id="epic-auth-code" type="text" placeholder="${t("epic.authCodePlaceholder")}" style="min-width: 260px;" />
                      <button id="epic-login-code" type="button">${t("epic.loginWithCode")}</button>
                    </div>
                  </div>
                </section>
              </section>
